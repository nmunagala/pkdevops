class sonarqube_ci (
  ...
  $templates_path = "/vagrant/environments/test/modules/sonarqube/templates") {
  ...
  file { 'bash_script':
    ...
    mode    => '0755',
    content => template('/vagrant/environments/test/modules/sonarqube/templates/sonar_env.sh.erb'),
